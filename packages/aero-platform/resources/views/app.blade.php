...
<head>
    ...
    <!-- SEO & Social Meta -->
    <meta name="description" content="{{ config('app.name') }} - Multi-Tenant SaaS Platform for Enterprise Resource Planning">
    <meta name="keywords" content="SaaS, Multi-Tenant, ERP, Enterprise Resource Planning, Business Management">
    ...
    <meta property="og:description" content="Multi-Tenant SaaS Platform for Enterprise Resource Planning">
    ...
    <meta name="twitter:description" content="Multi-Tenant SaaS Platform for Enterprise Resource Planning">
        ...
        <div class="loading-content" role="presentation">
            <div class="loading-logo" aria-hidden="true">
                ...
                <div class="loading-logo-fallback">
                    {{ substr($siteName ?? 'Aero', 0, 1) }}
                </div>
            </div>
            <div class="loading-spinner" aria-hidden="true"></div>
            <div class="loading-text" aria-hidden="true">{{ $siteName ?? config('app.name') }}</div>
            <div class="loading-subtitle" aria-hidden="true">Preparing your workspace...</div>
            <span class="sr-only" style="position: absolute; width: 1px; height: 1px; padding: 0; margin: -1px; overflow: hidden; clip: rect(0, 0, 0, 0); white-space: nowrap; border: 0;">Loading {{ $siteName ?? config('app.name') }}, please wait...</span>
        </div>
    </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const reactCheckInterval = setInterval(() => {
                reactCheckCount++;
                if (checkReactReady() || reactCheckCount > 15) {
