...
class BudgetController extends Controller
{
    ...
    {
        return Inertia::render('Project/Budget/Create', [
            'projects' => Project::select('id', 'project_name')->get(),
            'categoryOptions' => [
                'labor' => 'Labor',
                'materials' => 'Materials',
    ...
    public function show(ProjectBudget $projectBudget)
    {
        ...
        return Inertia::render('Project/Budget/Show', [
    ...
    {
        return Inertia::render('Project/Budget/Edit', [
            'budget' => $projectBudget,
            'projects' => Project::select('id', 'project_name')->get(),
            'categoryOptions' => [
                'labor' => 'Labor',
    ...
    public function expenses(ProjectBudget $projectBudget)
    {
        ...
        return Inertia::render('Project/Budget/Expenses', [
            'budget' => $projectBudget,
            'expenses' => $expenses,
        ]);
    }
    ...
    public function reports(Request $request)
    {
        ...
        return Inertia::render('Project/Budget/Reports', [
