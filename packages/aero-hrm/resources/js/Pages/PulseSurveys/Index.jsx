...
const PulseSurveysIndex = ({ title, stats: initialStats, departments }) => {
    ...
    const canManage = auth.permissions?.includes('hrm.pulse-surveys.manage') || auth.permissions?.includes('hrm.*') || auth.role === 'admin';
                            ...
                            <div className={`${!isMobile ? 'p-6' : 'p-4'} w-full`}>
                                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <h4 className="text-2xl font-bold">Pulse Surveys</h4>
                                            <p className="text-sm text-default-500">Quick engagement check-ins</p>
                                        </div>
                                    </div>
                                    {canManage && (
