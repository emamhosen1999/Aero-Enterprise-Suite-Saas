...
use AeroModules\Hrm\Models\Event;
use AeroModules\Hrm\Models\EventActivityLog;
use AeroModules\Hrm\Models\EventRegistration;
...
class PublicEventController extends Controller
{
    ...
    public function registrationSuccess(string $slug, string $token)
    {
        ...
        return Inertia::render('Public/Events/RegistrationSuccess', [
            'event' => $event,
    ...
    public function checkRegistration(Request $request)
    {
        ...
        return Inertia::render('Public/Events/CheckRegistration', [
            'registration' => $registration,
        ]);
    }
    ...
    public function downloadToken(string $token)
    {
        ...
        return Inertia::render('Public/Events/PrintToken', [
            'registration' => $registration,
        ]);
    }
