/**
 * Platform Admin Navigation Definition
 * 
 * Defines the sidebar navigation structure for Platform Admin (landlord context).
 * This mirrors the structure defined in aero-platform/config/module.php.
 * 
 * Icon Strategy:
 * - Icons are passed as strings (e.g., 'HomeIcon')
 * - The useNavigation hook resolves these to actual HeroIcon components
 * - This keeps bundles small and avoids icon import issues
 * 
 * Access Control:
 * - Each nav item specifies `access_key` path: "platform.submodule.component"
 * - Access is checked by the useNavigation hook
    ...
    */
    {
        ...
        children: [
            ...
            },
            {
                ...
                active_rule: 'admin.settings.localization',
    ...
    /*
    |--------------------------------------------------------------------------
    | 12. Developer Tools (developer_tools)
    |--------------------------------------------------------------------------
    */
    {
        name: 'Developer',
