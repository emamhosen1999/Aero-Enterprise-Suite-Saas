...
/**
 * Compliance Dashboard - Dynamic Widgets Only
 * 
 * This dashboard renders ONLY dynamic widgets registered by packages.
 * NO hardcoded widgets or container Card wrappers.
 * All compliance-specific widgets (policies, audits, risks, training) should be
 * registered via the widget system in the aero-compliance package.
 */
const ComplianceDashboard = ({ title = 'Compliance Dashboard', dynamicWidgets = [] }) => {
    ...
    return (
        <>
            <Head title={title} />
            <div className="flex flex-col w-full h-full p-4" role="main" aria-label="Compliance Dashboard">
                    ...
                    {!hasAnyWidgets && (
                        ...
                        >
                            ...
                            <p className="text-default-500 max-w-md">
                                Compliance widgets will appear here once configured.
                                Contact your administrator to set up policy, audit, risk, and training widgets.
                            </p>
                        </motion.div>
                    )}
                </div>
...
ComplianceDashboard.layout = (page) => <App>{page}</App>;
