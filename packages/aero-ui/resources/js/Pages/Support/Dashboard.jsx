...
const SupportDashboard = ({ title = 'Support Dashboard', dynamicWidgets = [] }) => {
    ...
    return (
        <>
            <Head title={title} />
            <div className="flex flex-col w-full h-full p-4" role="main" aria-label="Support Dashboard">
                    ...
                    {!hasAnyWidgets && (
                        ...
                        >
                            ...
                            <p className="text-default-500 text-center max-w-md">
                                ...
                                Widgets will appear here once they are registered by the support module.
                            </p>
                        </motion.div>
                    )}
                </div>
...
SupportDashboard.layout = (page) => <App>{page}</App>;
