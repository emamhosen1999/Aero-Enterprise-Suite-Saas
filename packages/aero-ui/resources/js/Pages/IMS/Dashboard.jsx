 ...
 * All inventory-specific widgets (stock levels, warehouses, movements) should be
 * registered via the widget system in the aero-ims package.
 */
const InventoryDashboard = ({ title = 'Inventory Dashboard', dynamicWidgets = [] }) => {
    ...
    return (
        <>
            <Head title={title} />
            <div className="flex flex-col w-full h-full p-4" role="main" aria-label="Inventory Dashboard">
                    ...
                    {!hasAnyWidgets && (
                        ...
                        >
                            ...
                            <p className="text-default-500 max-w-md">
                                Inventory widgets will appear here once configured.
                                Contact your administrator to set up stock, warehouse, and movement widgets.
                            </p>
                        </motion.div>
                    )}
                </div>
...
InventoryDashboard.layout = (page) => <App>{page}</App>;
