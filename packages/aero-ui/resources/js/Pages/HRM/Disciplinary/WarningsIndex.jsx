                            ...
                            <Card className="transition-all duration-200" style={getThemedCardStyle()}>
                                    ...
                                    <div className={`${!isMobile ? 'p-6' : 'p-4'} w-full`}>
                                        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                                            <div className="flex items-center gap-3 lg:gap-4">
                                                ...
                                                <div>
                                                    <h4 className={`${!isMobile ? 'text-2xl' : 'text-xl'} font-bold`}>Warnings</h4>
                                                    <p className={`${!isMobile ? 'text-sm' : 'text-xs'} text-default-500`}>Manage employee warnings and disciplinary actions</p>
                                                </div>
                                            </div>
                                            {canCreate && (
                                ...
                                <CardBody className="p-6">
                                    ...
                                    <div className="flex flex-col sm:flex-row gap-4 mb-6">
                                        <Input label="Search" placeholder="Search warnings..." value={filters.search} onChange={(e) => setFilters(prev => ({ ...prev, search: e.target.value }))}
