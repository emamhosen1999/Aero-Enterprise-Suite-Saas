/**
 * Shared Role Management Component
 * 
 * Used by both Tenant Role Management and Platform Admin Role Management.
 * The component adapts its behavior based on the `is_platform_context` prop:
 * - false: Uses tenant-specific routes (/api/roles)
 * - true: Uses platform admin routes (/roles direct)
 */
