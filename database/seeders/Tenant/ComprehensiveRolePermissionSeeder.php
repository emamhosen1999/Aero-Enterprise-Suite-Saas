...
class ComprehensiveRolePermissionSeeder extends Seeder
{
    ...
    private function assignPermissionsToRoles(): void
    {
        ...
        $hrPermissions = Permission::where('name', 'like', 'core.%')
        ...
        $projectPermissions = Permission::where('name', 'like', 'core.%')
        ...
        $deptPermissions = Permission::where('name', 'like', 'core.%')
            ->orWhereIn('name', [
                'employees.view',
                'employees.update',
                'attendance.view',
        ...
        $teamPermissions = Permission::where('name', 'like', 'core.%')
            ->orWhereIn('name', [
                'employees.view',
                'attendance.view',
                'leaves.view',
        ...
        $seniorPermissions = Permission::where('name', 'like', 'core.%')
            ->orWhereIn('name', [
                'daily-works.view',
                'daily-works.create',
                'daily-works.update',
        ...
        $employeePermissions = Permission::where('name', 'like', 'core.%')
            ->orWhereIn('name', [
                'daily-works.view',
                'daily-works.create',
                'tasks.view',
