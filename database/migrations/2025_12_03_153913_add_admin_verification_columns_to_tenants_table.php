...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('tenants', function (Blueprint $table) {
            ...
            $table->string('admin_email_verification_code', 6)->nullable()->after('admin_phone_verified_at');
            $table->timestamp('admin_email_verification_sent_at')->nullable()->after('admin_email_verification_code');
            $table->string('admin_phone_verification_code', 6)->nullable()->after('admin_email_verification_sent_at');
